  ...
  return (
    <div className="w-11/12 lg:w-9/12 grid grid-cols-1 lg:grid-cols-2 gap-5 mx-auto h-[88vh] mt-10">
        ...
        >
          <div className="space-y-1 text-sm">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-md border border-solid-1 focus:outline-none"
            />
          </div>
          <div className="space-y-1 text-sm">
          ...
          <button
            className="block w-full p-3 text-center rounded-sm border-2 border-success bg-primary text-white"
            type="submit"
          >
            Sign Up
          </button>
      ...
      <div className="border border-solid-2 w-full shadow-md hidden lg:block">
        <img className="h-[88vh] w-[850px]" src="../../../login.gif" alt="" />
      </div>
    </div>
  );
};
