    ...
    return (
        <div>
            ...
            <div className='text-info lg:my-20 w-11/12 mx-auto flex lg:flex-row md:flex-row flex-col gap-5 lg:gap-0 md:gap-0 justify-between items-center bg-neutral px-2 py-3 rounded-lg'>
                <div>
                    <h3 className='text-lg font-semibold'>We found  <span className='text-accent font-bold'>{allCourse.length}</span> courses available for you</h3>
                </div>
                        ...
                        allCourse.map(course => {
                            return <div key={course._id} className='shadow-lg border border-slate-200'>
                                <div className='relative'>
                                    ...
                                    <p className="text-xl absolute right-2 text-white bottom-2 badge badge-secondary py-4 rounded-sm">${course.price}</p>
                                </div>
                                <div className="my-4 px-5 py-3">
                                    <div className='flex justify-between items-center mx-2'>
                                        <div className="text-lg inline p-1 rounded-md text-secondary border border-secondary">Category Name</div>
