      ...
      <div className="w-9/12 mx-auto">
        <div className="text-center text-black">
          ...
          <p className="w-1/2 mx-auto my-2">
            Morbi ligula massa, commodo at nisl tincidunt, dignissim feugiat
            metus. Suspendisse placerat lacinia porttitor. Vivamus
          </p>
        </div>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10">
          {categories.map((category) => (
            <div
              key={category._id}
              className="w-95 flex items-center bg-white rounded-md p-5 py-10 text-black justify-around shadow-xl hover:bg-secondary transition-all duration-500"
            >
