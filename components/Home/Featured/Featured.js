    ...
    <div className='bg-white py-10 lg:py-20'>
      <div className='w-9/12 mx-auto'>
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10'>
          {
            categories.map(category => <div className='flex items-center bg-white rounded-md p-5 py-10 gap-5 text-black justify-center shadow-xl hover:bg-secondary transition-all duration-500'>
