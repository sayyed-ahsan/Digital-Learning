    ...
    return (
        ...
        <div className='col-span-2'>
            ...
            <ul className='list-disc list-inside flex flex-col gap-3 font-medium'>
                ...
                <li>How should a new product be positioned when it’s launched? Which customer segments</li>
                <li>Where Ever Home is –Is where we will be able to provide Service</li>
            </ul>
            <div className='my-5'>
                <div className='flex items-center justify-between'>
                    <h3 className='text-2xl font-semibold mb-4'>Topics for this course</h3>
                    ...
                    <div className="container flex flex-col justify-center">
                        <div className="space-y-4 text-secondary">
                            ...
                            <details className="w-full border border-secondary rounded-lg  cursor-pointer">
                                <summary className="px-4 py-6 text-xl font-semibold">Introduction</summary>
                                <div className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400 font-medium flex gap-2 items-center justify-between">
                            ...
                            <details className="w-full border border-secondary rounded-lg  cursor-pointer">
                                <summary className="px-4 py-6 text-xl font-semibold">Frontend web Development</summary>
                                <div className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400 font-medium flex gap-2 items-center justify-between">
                                    <div className='flex gap-2 items-center'>
                                        <BsYoutube />
                                        <span>What you will get In this Course</span>
                            ...
                            <details className="w-full border border-secondary rounded-lg  cursor-pointer">
                                <summary className="px-4 py-6 text-xl font-semibold">Introduction to HTML</summary>
                                <div className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400 font-medium flex gap-2 items-center justify-between">
                                    <div className='flex gap-2 items-center'>
                                        <BsYoutube />
                                        <span>What you will get In this Course</span>
                        ...
                        <div className="flex items-center gap-10 px-2 py-5">
                            ...
                            <div className="flex flex-col space-y-4">
                                ...
                                <div className="space-y-1">
                                    <p>I've spent the last few years teaching people to program at 2 different immersive bootcamps where I've helped hundreds of people become web developers and change their lives. My graduates work at companies like Google, Salesforce, and Square. I've helped hundreds of people become web developers</p>
                                </div>
                            </div>
