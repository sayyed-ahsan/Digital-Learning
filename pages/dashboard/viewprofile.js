...
const viewprofile = () => {
  ...
  const handleUpdate = (event) => {
    ...
    console.log(data);
    const url = `https://digital-learning-ruddy.vercel.app/api/updateUser/${id}`;
    fetch(url, {
      method: "PUT",
      headers: {
    ...
    <Dashboard>
      <div className="pt-5 lg:pt-10 px-5 lg:px-40 mt-10 bg-neutral text-black">
        ...
        <div className="flex justify-center lg:justify-between gap-2">
          <div>
            <h2 className="text-xl lg:text-3xl font-semibold">{user?.name}</h2>
            <p className="py-2 mb-5 w-28 lg:w-full text-xs lg:text-base">
              Welcome to Your Profile page
            </p>
          </div>
          <div className="text-xs lg:text-md breadcrumbs">
            <ul>
              <li>
                <Link href={"/"}>Home</Link>
              </li>
