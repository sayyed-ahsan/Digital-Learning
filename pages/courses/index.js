      ...
      <div className="text-black mx-auto w-11/12 grid lg:grid-cols-4 gap-5">
            ...
            return (
              <div key={category._id} className="py-1">
                ...
                <label
                  ...
                  className="flex cursor-pointer items-center rounded-lg border border-gray-100 p-2 text-sm font-medium shadow-sm hover:border-secondary peer-checked:border-secondary peer-checked:ring-1 peer-checked:ring-secondary"
                >
        ...
        <div className="grid xl:grid-cols-3 lg:grid-cols-2 lg:col-span-3 md:grid-cols-2 grid-cols-1 gap-5 p-2 rounded-md">
          {allCourses.map((course) => {
            ...
            return (
              <div key={_id} className="shadow-lg border border-slate-200">
                ...
                <div className="my-4 px-5 py-3">
                  ...
                  <h2 className="text-gray-900  text-xl font-semibold h-16">
                    {title}
                  </h2>
                  <p className="my-5 h-20">{subtitle}</p>
                  <Link
                    href={`/courses/${_id}`}
